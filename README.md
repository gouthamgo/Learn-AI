...
# Navigate to Phase-1-Foundations/Week-1-Python-Basics/
# Open any .ipynb file
```
...
### 1️⃣ Follow the Path
Start with Week 1, Day 1 and work sequentially. Each lesson builds on the previous one!

### 2️⃣ Hands-On Learning
**IMPORTANT**: Don't just read the code - RUN IT!
- Click the ▶️ button on each code cell in Google Colab
- Modify the code and see what happens
- Break things and fix them (best way to learn!)

### 3️⃣ Do ALL Exercises
...
**Remember**: The best way to learn AI is by DOING. Run every code cell, experiment, break things, and build projects!
